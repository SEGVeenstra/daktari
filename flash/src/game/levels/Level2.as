package game.levels 
{
	...
	public class Level2 extends Level 
	{
		...
		override protected function Build():void 
		{
			...
			AddGameObject(new Platform('fence', 121, 6, 1, 70));
			...
			var item1:Item = new Item('item_1', 50, 76);
			...
			var npc3:Npc = new Npc('npc_3', 106, 33, 3, 6, 100000);
			AddGameObject(npc3);
			...
			AddGameObject(new Switch('switch_red_1', 111, 86,new Image(Assets.GetCollectableTexture('green_apple')),new Image(Assets.GetCollectableTexture('red_apple'))));
			...
			AddGameObject(new Switch('switch_green_1', 111, 69,new Image(Assets.GetCollectableTexture('green_apple')),new Image(Assets.GetCollectableTexture('red_apple'))));
			...
			AddGameObject(new Switch('switch_blue_1', 111, 52,new Image(Assets.GetCollectableTexture('green_apple')),new Image(Assets.GetCollectableTexture('red_apple'))));
			...
			AddGameObject(new Switch('switch_brown_1', 111, 35,new Image(Assets.GetCollectableTexture('green_apple')),new Image(Assets.GetCollectableTexture('red_apple'))));
