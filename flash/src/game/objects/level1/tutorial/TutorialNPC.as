package game.objects.level1.tutorial 
{
	 ...
	 * @author SEG.Veenstra
	 */
	public class TutorialNPC extends TutorialObject 
	{
		private var image:Image = new Image(Assets.GetAtlas('tutorial').getTexture('quest'));
		
		public function TutorialNPC(id:String,x:Number,y:Number) 
		{
			super(id, x, y, 4, 1);
			addChild(image);
			image.y = -300;
